...
public class RuntimeMeasurement {
    ...
    public static void main(String[] args) {
        System.out.println("Loading: " + evaluateNumberOfCompLoading());
        System.out.println("searchName: " + evaluateNumberOfCompSearchingForName());
        System.out.println("searchEmail: " + evaluateNumberOfCompSearchingForEmail());
        System.out.println("Removing: " + evaluateNumberOfCompRemoving());
    }
}
