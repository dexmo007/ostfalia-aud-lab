 ...
 * @author M.Gruendel
 */
public class MyContactListTest1Public {
    ...
    public void testMyContactListEmptyFile() throws IOException {
        new MyContactList("Materialien/public/ContactEmpty.csv");
    }
    ...
    public void testMyContactListNotExit() throws IOException {
        new MyContactList("Materialien/public/x.csv");
    }
    ...
    public void testMyContactListBigFile() throws IOException {
        MyContactList mc = new MyContactList("Materialien/public/Contacts25k.csv");
    ...
    public void testSize() throws IOException {
        MyContactList mc = new MyContactList("Materialien/public/ContactEmpty.csv");
    ...
    public void testGetName() throws IOException {
        MyContactList mc = new MyContactList("Materialien/public/Contact9-0.csv");
    ...
    public void testRemoveEntriesByMailMixed() throws IOException {
        MyContactList mc = new MyContactList("Materialien/public/Contact9-3.csv");
        assertEquals("Größe ungültig!", 9, mc.size());
        //-----------------------------------------------
    ...
    public void testRemoveEntriesByMailDouble() throws IOException {
        MyContactList mc = new MyContactList("Materialien/public/Contact7-2.csv");
        assertEquals("Größe ungültig!", 7, mc.size());
        //-----------------------------------------------
